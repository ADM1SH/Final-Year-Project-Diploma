"""
Configures Django admin panel interfaces for categories, profiles, items,
transactions, scam reports, and reviews.
"""
...
class ItemAdmin(admin.ModelAdmin):
    ...
    # Group listing details and quality surveys into structured fieldsections
    fieldsets = (
        (None, {
