...
export const ProfileScreen = () => {
  ...
  const myItems = items.filter(item => item.seller?.username === (user?.username || 'Adam Anwar'));
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      <View style={styles.header}>
        ...
        <View style={styles.profileSection}>
          ...
          <Text style={styles.bio}>Curating a collection of high-quality, pre-loved minimalist furniture and designer accessories.</Text>
        ...
        <View style={styles.statsRow}>
          <View style={styles.statItem}><Text style={styles.statValue}>24</Text><Text style={styles.statLabel}>Live Listings</Text></View>
          <View style={styles.statItem}><Text style={styles.statValue}>89</Text><Text style={styles.statLabel}>Items Sold</Text></View>
          <View style={styles.statItem}><Text style={styles.statValue}>4.9</Text><Text style={styles.statLabel}>Rating</Text></View>
          <View style={styles.statItem}><Text style={styles.statValue}>1.2k</Text><Text style={styles.statLabel}>Followers</Text></View>
        </View>
        ...
        <View style={styles.impactCard}>
          <View style={styles.impactContent}>
            ...
            <View style={styles.impactTextContainer}>
              ...
              <Text style={styles.impactSub}>Your contribution to circular economy</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <View style={styles.tabSection}>
        <View style={styles.tabs}>
          {['My Listings', 'Sold Items', 'Reviews'].map(tab => (
