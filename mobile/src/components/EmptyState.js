...
const EmptyState = ({ icon, title, description, actionText, onActionPress }) => {
    return (
...
// Pure presentational — memoised to avoid re-renders from parent state changes
// unrelated to this component's own props.
