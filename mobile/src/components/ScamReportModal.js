...
// Defined once outside the component so the array reference is stable.
...
export const ScamReportModal = ({ visible, onClose, item, sellerId, sellerName, onSuccess }) => {
    ...
    // Reset form state when the modal closes to ensure a clean sheet next time.
    ...
    const handleSubmit = useCallback(async () => {
        const finalReason = `${REPORT_REASONS[selectedReasonIndex]}${
    ...
    }, [selectedReasonIndex, customDetails, sellerId, item, onSuccess, handleClose]);
